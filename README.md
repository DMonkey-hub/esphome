...
The buttons 10-40 resets the Test meter to that value for 1 second. Touching the meter resets it to zero. Touching the clock displays a simple message box.
